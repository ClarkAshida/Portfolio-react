    ...
    return (
        <div className="aboutme" id="aboutme">
            <div className="aboutme-container" data-aos="fade-down">
                ...
                <Button btnText="Baixar Currículo" btnLink="https://academicoifrnedu-my.sharepoint.com/personal/flavio_alexandre_academico_ifrn_edu_br/Documents/Curr%C3%ADculo.pdf" btnStyle="btn-container" blank="_blank"/>
                </div>            
            </div>
        </div>
    )
